...
# 将结果保存到新的CSV文件中
original_results.to_csv('original_output_glm4_flash.csv', index=False, header=['generated_content'], encoding='utf-8')
obfuscated_results.to_csv('obfuscated_output_glm4_flash.csv', index=False, header=['generated_content'], encoding='utf-8')
test_target_results.to_csv('test_target_output_glm4_flash.csv', index=False, header=['generated_content'], encoding='utf-8')
